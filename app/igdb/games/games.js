...
const fetchAllGames = async (requestsCount, limit, offset, allGames) => {
    ...
    const url = `https://api-endpoint.igdb.com/games/?fields=*&expand=collection,franchise,developers,publishers,platforms,game_modes,genres&limit=50&offset=${offset}`;
